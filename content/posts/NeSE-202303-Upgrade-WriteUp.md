...
![](https://hujiekang.top/images/uploads/big/0f68ea6f212fd2d74c388c84597766f3.png)
...
![](https://hujiekang.top/images/uploads/big/2914e2da02adfd7b51f326323b4f7945.png)

接下来看inQuoted为true的处理。可见除非再次碰到了引号（说明引号括起来的部分结束了）或者碰到了`\x00`（字符串结束了）这两种情况，否则就会将后面的字符一直读取为当前Cookie的值。这就给利用提供了机会。

![](https://hujiekang.top/images/uploads/medium/aeb22808f351b9440b4288d6bed97ae1.png)

所以只要下面这种情况，就可以直接读取到Flag：

![](https://hujiekang.top/images/uploads/big/b61c5072f5ef240881cf2a0ee04f409c.png)
...
![](https://hujiekang.top/images/uploads/big/710bb8486321e3521d1114eadd60d745.png)
...
![](https://hujiekang.top/images/uploads/big/4fbc792683281e41eaf772f4f612d711.png)
