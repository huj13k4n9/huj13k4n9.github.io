...
![](https://hujiekang.top/images/uploads/big/5fb128ef04124fa06fd59bd620d800fc.png)

于是乎只能另寻他路。通过断点调试可以发现，`renderFile()`方法中取了传入参数的`settings['view options']`，将其Copy到最终渲染的参数对象中。

![](https://hujiekang.top/images/uploads/big/7008f6a7fe49872f4d267d1218f4e75d.png)
...
![](https://hujiekang.top/images/uploads/big/e3925dbe624168e0b1e570c7cc0d3e28.png)
...
![](https://hujiekang.top/images/uploads/big/db932642fc6e6e7c0eed7622b012a53e.png)
...
![](https://hujiekang.top/images/uploads/big/ac34c63757aeb9473a2cf558083d57f6.png)
...
![](https://hujiekang.top/images/uploads/big/ef3d88a4240829fd5fe0e31513530175.png)
...
![](https://hujiekang.top/images/uploads/medium/a2165fd4ebeaf4649401cbd72544318d.png)
...
![](https://hujiekang.top/images/uploads/big/95ad8d5f83d424a23b2777efdaf691f2.png)
...
![](https://hujiekang.top/images/uploads/big/58c25bb80b0a60e31458f87fe58f5565.png)

提权之后，能够做的事情就比普通用户多很多了。首先注意到可以新建和管理已存在的软件仓库，在仓库的选项页面，可以指定Directory，也就是仓库目录的位置。将其修改为根目录`/`，就相当于把整个系统目录当成仓库创建了，也就可以读取任意文件了。

![](https://hujiekang.top/images/uploads/big/150e89ed4ac6176d8e428791995c48fe.png)

在创建仓库的时候会提示无法创建/.indexer文件的错误，但是仓库已经被创建好了，直接访问即可，实现了任意文件读取。

![](https://hujiekang.top/images/uploads/big/a1da2ae8954595ca8cb097e6545aa030.png)
...
![](https://hujiekang.top/images/uploads/big/d9a4263477e71800728781ef798caec5.png)
