...
![](https://images.hujiekang.top/blogimage-9d0eb9841e3d66998909c36db230e151-947f1fc6.png)

**更新：** 后面再次尝试，发现只是插件不行，利用`LD_PRELOAD`环境变量劫持同样可以RCE：（更多请看我[之前的文章](/2020/04/22/Ha1cyonCTF-WriteUp/#realezphp)）

![](https://images.hujiekang.top/blogimage-0d99cd64bf23d22e04ec1189447b228c-5edf2231.png)
...
![](https://images.hujiekang.top/blogimage-a7daea8cb32ba87111648ddb474e34c4-e13809a3.png)
...
![](https://images.hujiekang.top/blogimage-232690379e86bd312de345343fd3a6f6-0e38f84b.png)
...
![](https://images.hujiekang.top/blogimage-16665f5c80777fc7b5fa54f257038b71-a989bb98.png)
...
![](https://images.hujiekang.top/blogimage-8336794ba7552209ff6725889dbff613-1e71d4a7.png)

顺藤摸瓜摸到这个Python文件，发现权限是766，也就是可修改：

![](https://images.hujiekang.top/blogimage-e2c810737f3e8e8852335394511c35b0-093ea6ce.png)
...
![](https://images.hujiekang.top/blogimage-1052084b6c27d6a1d29ada18ee9c160c-d8d2b144.png)
...
![](https://images.hujiekang.top/blogimage-49605e43264b0f36f48023cf85c9405d-b1852733.png)

## code obfuscation

附件是一张图片：

![](https://images.hujiekang.top/blogimage-e50953ce7a939147006c6c6030cf9f94-e251e4d0.png)

用PS消除间隔并矫正形状得到二维码：

![](https://images.hujiekang.top/blogimage-66aca3c6a9623b2c2b208b4b432f6dfc-c8676a38.png)

扫描结果为`base(gkctf)`，此时没有更多信息了，于是尝试再次提取原图片的信息。

使用Stegslove，发现图片中有另一个数据块，很明显能够发现RAR的文件头`52 61 72 21`：

![](https://images.hujiekang.top/blogimage-c93325fe8925e760f6124c1ccbd9aad1-3b99c694.png)
...
![](https://images.hujiekang.top/blogimage-9319cb0569f5bc7da5a0d5657e00524f-4e24ab5a.png)
...
![](https://images.hujiekang.top/blogimage-92638b7b58c8010453041ee0a864cd31-1a9afce2.png)
...
<img src="https://images.hujiekang.top/blogimage-c41159cb8521607c6045dda4041248bd-4baa813b.jpg" style="zoom:50%;" />

拿到密码为`ctfisfun`，解开图片中的文档：

![](https://images.hujiekang.top/blogimage-f2e343f897f3acc2670997622c069ece-97fa5523.png)
...
![](https://images.hujiekang.top/blogimage-f7e4e752981d5d7017c797f0936190a1-654c4684.png)

扫描得到一个百度网盘的链接，但是不知道提取码，只能再回去翻看视频找找线索。

借助hint1，找了几遍后发现了“闪烁的光芒”，就是视频中间那个摄像头：

![](https://images.hujiekang.top/blogimage-029a120e0f3ed31e7d49b90efa7a4f2e-78ac333b.png)
...
![](https://images.hujiekang.top/blogimage-741e1af908b77e1c215c3f20685ed88c-fd659c43.png)

压缩包密码`GG0kc.tf`，解压出来得到一个`.ovex`文件，用五线谱打谱软件Overture打开即可拿到flag：`flag{gkctf_is_fun}`

![](https://images.hujiekang.top/blogimage-6b5d1a2fcf4ea992c84433ddc1a9ad17-21ed9bcb.png)
