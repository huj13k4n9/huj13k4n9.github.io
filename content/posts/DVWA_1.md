...
![](https://images.hujiekang.top/blogimage-52bb3a5d956d9c0c61979c4bcd43c8c2-56462684.png)
...
![](https://images.hujiekang.top/blogimage-ed70548eba781d2814ab252310f59d3f-f2b8a1e0.png)
...
![](https://images.hujiekang.top/blogimage-a1c98c44114699fb724ac8c2e5142135-00a121db.png)
...
![](https://images.hujiekang.top/blogimage-5e7ed1add717be863d99689d8e0e1425-e39dfb02.png)
...
![](https://images.hujiekang.top/blogimage-0c57ed92b05c097add0413e4ff6384c1-78f7c567.png)
...
![](https://images.hujiekang.top/blogimage-1878234d1625208cfa8d4a351c53fc67-415cb542.png)

访问`execute.php?cmd=ls`，结果如下：

![](https://images.hujiekang.top/blogimage-df8b88cc450a16931cc1ac7b312f239c-f7eb286b.png)

访问`execute.php?cmd=rm%20test.txt`后查看文件夹，发现`test.txt`已被删除：

![](https://images.hujiekang.top/blogimage-32cd5f7a48cc2989fe8319b87dcb6c32-59bf69fe.png)
...
![](https://images.hujiekang.top/blogimage-087f1bc338e7cdc7c6bbc7e3557f1772-032dec0c.png)

## 安全等级`Low`

`Low`等级中，除了验证新密码和确认密码是否一致之外，没有对请求的信息做任何的验证。而且表单的源代码中体现了所有参数的提交方式是`GET`。

![](https://images.hujiekang.top/blogimage-8d20226541187edd3d2532709b583082-8c560abf.png)
...
![](https://images.hujiekang.top/blogimage-2e83908071fe61065f1c606b3c93c9b6-78bbbc8f.png)

访问DVWA用户数据库，发现当前用户(admin)的密码md5值已被更改，原有密码无法登录。

![](https://images.hujiekang.top/blogimage-cd8f0ee6cb66a1a084ee50e99c5be052-339aafa3.png)
...
![](https://images.hujiekang.top/blogimage-b303b5ba2fe7535741f6b3547fdeacf6-c20c9fe3.png)
...
1. **同源`iframe`弹出Token，再手动发出请求**
  ...
  ![](https://images.hujiekang.top/blogimage-7a9d4ed1042accb73be69a87600237b2-e003b3b7.png)

  这就相当于在页面里面添加了一个`iframe`用于加载CSRF页面，再通过HTML事件，在`iframe`加载的时候弹出Token。

  ![](https://images.hujiekang.top/blogimage-c47102901d7812804cf8b0b2a66f53cd-de29904a.png)

  得到Token之后，就可以利用那个恶意HTML文件添加`user_token`参数发起攻击。

  ![密码修改成功](https://images.hujiekang.top/blogimage-bb38811747143136e275df7d3612f977-96333cbd.png)
...
2. **XSS引入外部js，借助`XMLHttpRequest`自动发起请求**
  ...
  ![密码修改成功](https://images.hujiekang.top/blogimage-9e69a46940e14503c853223442a25afc-52ce5e15.png)
...
![](https://images.hujiekang.top/blogimage-363def069eb621c4f836f9583598a4fd-ea3d7344.png)
![](https://images.hujiekang.top/blogimage-11baddec6a530f6247e812225fbc1672-33e6d670.png)

### 安全等级`Low`

`Low`等级没有做任何的过滤与保护，单纯靠前端的代码进行操作。所以构造Payload`default=<script>alert(document.cookie)</script>`，提交后直接弹出网页的`cookie`：

![](https://images.hujiekang.top/blogimage-6669878003357dc63242ec3dcc4485c7-0a1a84d7.png)
...
![](https://images.hujiekang.top/blogimage-2b2c457044133c78f13d113a1287e981-2d80bdb3.png)
...
![](https://images.hujiekang.top/blogimage-f85dbb00907a1dbc087ef38ab0707bac-447c8717.png)
...
![](https://images.hujiekang.top/blogimage-b0c274ecb251d1feda0f1ee774d2077c-ffc9ff0f.png)
...
![](https://images.hujiekang.top/blogimage-e99839be65d9bb2890ee72f2bb720708-72c2f8dd.png)
...
![](https://images.hujiekang.top/blogimage-394c03afbd6067da1b346f635249795d-2911dd5b.png)
...
![](https://images.hujiekang.top/blogimage-f68a98465733e966043c1ea02fd93810-30893b24.png)
...
![](https://images.hujiekang.top/blogimage-6c7a15cf2dbc07126a27e5505c236595-db3a4b36.png)
...
![](https://images.hujiekang.top/blogimage-5f82efa66e8d4a21c2cc77cc5ec5cabb-851eca67.png)
