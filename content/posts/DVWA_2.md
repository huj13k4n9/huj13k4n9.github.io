...
![](https://images.hujiekang.top/blogimage-25c1fbdaabb65151e31b5355bfe4fb6f-3367655b.png)
...
![](https://images.hujiekang.top/blogimage-3b1845c23dada8de1346451ca4cb5c0f-be1e6d74.png)
...
![](https://images.hujiekang.top/blogimage-7ead363c966de123270483993e1156aa-9d7fddd4.png)
...
![](https://images.hujiekang.top/blogimage-f8f50aed41a9fd2b8fd5c6fd93209a26-0822a3ba.png)
...
![](https://images.hujiekang.top/blogimage-eb3bb4cb0eff2fdf592cbb0cac6e56b3-ca4725b2.png)

## 安全等级`Impossible`

`Impossible`首先对数据库加入了PDO防止了SQL注入，然后对多次登录失败的情况使用了账户锁定15分钟的措施，有效的防止了爆破。

![](https://images.hujiekang.top/blogimage-e21f7b5ff9ee4d8beb6bca3a72c9a20b-b09fee40.png)
...
![](https://images.hujiekang.top/blogimage-388fd07e250dbab69c66c5a718fb2036-1d945a56.png)
...
1. `RFI`
  ...
  ![](https://images.hujiekang.top/blogimage-ed4545019d3f87248ba909214d3b3cf1-54ebec68.png)
...
2. `LFI`
  ...
  ![](https://images.hujiekang.top/blogimage-124f7ad95ae79d53bfa0c3cd3aacaeed-294184b4.png)
...
![](https://images.hujiekang.top/blogimage-191e3a49eca3864960253bfb91b27932-d1af2921.png)
...
![](https://images.hujiekang.top/blogimage-dcdbc57fa2ddcac74b5e865890be46fe-c2b194ca.png)
...
![](https://images.hujiekang.top/blogimage-fd5ece97a53bf9f1da9454960229a294-955c9902.png)
...
![](https://images.hujiekang.top/blogimage-c6fdb69c0c82a649a638de7a77044f1f-51653fb5.png)

然后使用中国蚁剑连接靶机，取得Webshell，可以任意访问靶机中的所有文件，以及虚拟终端：

![](https://images.hujiekang.top/blogimage-54ff028e043790e1b813bacdaa3a83a3-9c88e7b5.png)
...
1. 恶意图片文件+文件包含
   ...
   ![](https://images.hujiekang.top/blogimage-f57093ae33303204ab85380b6d027a20-9ced5dbb.png)
   ...
   ![](https://images.hujiekang.top/blogimage-ceea56894124a0de01567d611470dbd5-c69f5dc1.png)

2. Burpsuite直接改后缀名
   这个太简单了，抓包改掉后缀即可。。。放一张图吧

   ![](https://images.hujiekang.top/blogimage-4c8c43fea794771e62457b02f6a8280d-eea4921c.png)
...
3. Burpsuite改`chr(0)`截断
   ...
   ![](https://images.hujiekang.top/blogimage-3a5808cd22d6d9eecd6b417de6e6a47e-713726e2.png)
...
1. Windows下`cmd`中使用`copy`命令可以直接将两个文件合并（Powershell中无效，原因未知）
   ...
   ![](https://images.hujiekang.top/blogimage-2582c2172031d07dce84256c25d1b2f7-826582b9.png)
...
2. 使用[ExifTool](https://exiftool.org/)修改图片文件头
   ...
   ![](https://images.hujiekang.top/blogimage-90dba4d9b79d8193f134fcccf23c007e-389dba19.png)

接下来上传文件，没有问题成功上传：

![](https://images.hujiekang.top/blogimage-d34f1b4b81b29b7c7480b872728f74a2-0674ad3e.png)
...
![](https://images.hujiekang.top/blogimage-7096649dce3d1273a5b85e40983dfe5a-6d0e7937.png)
...
![](https://images.hujiekang.top/blogimage-e5091e34983b3ccea4791f3e45c2ba8a-2297031e.png)
...
![](https://images.hujiekang.top/blogimage-0eb47c2d8af51532dffca836e33cc5d7-21d9cbc2.gif)
![](https://images.hujiekang.top/blogimage-a77964b23cf2c386134c832a18ecfa8c-fc7acfb3.gif)
...
![](https://images.hujiekang.top/blogimage-6362b5f425c08a735e404dd5ca96eb0e-f6a9fdd7.png)
...
1. 查询所有数据库名称（`information_schema`数据库下的`schemata`数据表中的`schema_name`列）：
   ...
   ![](https://images.hujiekang.top/blogimage-dc132527a2c3c39f6a0b87c3984e8232-fda9ef25.png)
...
2. 查询当前数据库下的所有数据表名称（`information_schema`数据库下的`tables`数据表中的`table_name`列）：
   ...
   ![](https://images.hujiekang.top/blogimage-c34329fbbce59345606c63d7689014e4-ab98f04a.png)
...
3. 获取数据表下所有列名称（`information_schema`数据库下的`columns`数据表中的`column_name`列）：
   ...
   ![](https://images.hujiekang.top/blogimage-56553a3da67289461cb41d400894fc00-99470515.png)

4. 获取数据：
   `id=1' union select user,password from users#`

   ![](https://images.hujiekang.top/blogimage-7582a38e54a78c0a35fa180e0f2ad263-dc479a94.png)

至此，数据已经顺利拿到。
在某些场景中，页面可能限制了单次显示的数据条数，此时可用`group_concat()`函数来实现在一条记录里展示多个结果：

![](https://images.hujiekang.top/blogimage-679425014669ca177d4ba840dd582732-8464cdf3.png)
...
![](https://images.hujiekang.top/blogimage-0bb82af808605cede1c5faacaa209e52-7edb791d.png)
...
![](https://images.hujiekang.top/blogimage-dd9435864bfa25740b5557cb36650964-75f39bdc.gif)

之后的步骤基本和`Low`一致，但是由于引号不能被使用，所以在获取数据列的时候需要将数据表名用16进制表示，以避免引号的使用：

![](https://images.hujiekang.top/blogimage-56db2a66ea78c5327d0b21c42be171e0-22264197.png)
...
![](https://images.hujiekang.top/blogimage-e9de83cc212d1bfa65924ce99ffbd35a-6d112f11.gif)
