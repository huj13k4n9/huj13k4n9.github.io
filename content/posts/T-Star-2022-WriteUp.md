...
![](https://hujiekang.top/images/uploads/big/80f36f37a424db182cae21a5f6747292.png)

<!-- more -->

输入验证码后进入网站，就一个十分简陋的网站，有四个直播间页面，都在放TSRC的宣传视频hhh，然后扫接口在点赞的地方找到了一个XXE（赛后复盘的时候站已经关了，放一张当时的截图）

![](https://hujiekang.top/images/uploads/big/69bc53abc16689c5db1c556f66178b77.png)
...
![](https://hujiekang.top/images/uploads/big/6fbf7f6609cb45248cc1926580e5db0d.png)
...
![](https://hujiekang.top/images/uploads/big/c4cc5006f41223a2b126b9b1012720aa.png)

于是又去流量包里追踪了其他的流，发现后面开了一下ADB Shell，有`cat pass`的操作，获得密码：

![](https://hujiekang.top/images/uploads/big/8813378cf59e515076b8829a87ab5eff.png)

解压备份数据后得到以下文件：

![](https://hujiekang.top/images/uploads/big/7d45e09951234ff8cf6530ccae903c29.png)
...
![](https://hujiekang.top/images/uploads/big/ce582b92a615968a85e923f4a4ee7c8a.png)
...
![](https://hujiekang.top/images/uploads/big/2195e62a99bfe390c8ca9ea71f3a7034.png)

# 关卡4

压缩包解压下来是一个残缺的二维码和另一个压缩包，二维码补全之后得到一个URL，下载后又得到一个加密的压缩包call_me.zip

![](https://hujiekang.top/images/uploads/big/70d4d20764889509e2e5f24ed6943539.png)

在最开始解压出来的那个压缩包是没有密码的，解压下来是一段音频，用Audition打开一眼就看出是摩斯电码：

![](https://hujiekang.top/images/uploads/big/0034fcf7a6e18d028008f888250fe647.png)
...
![](https://hujiekang.top/images/uploads/big/50f792f721393827210f9ad282853178.png)

摸了一下其他的接口，感觉没什么可控的变量，最后摸到了购买的接口，比赛的时候我一直在试可能是不是`int32`溢出，发现就算溢出了也只是报错不会继续执行，于是当时就放弃了，就像下面这样子：

![](https://hujiekang.top/images/uploads/big/4c3b2939f2dd77fb9efb04c91ddf5564.png)
...
![](https://hujiekang.top/images/uploads/big/d1199884c46c01625b81ea415fa0fcd5.png)

站内信获得消息

> 商品【付费咨询】购买成功，信息如下： 前往微信公众号“腾讯安全应急响应中心”(tsrc_team)，回复"T-Star666"获取信息

![](https://hujiekang.top/images/uploads/big/27155987a463d739a7f041084a869474.jpg)
...
![](https://hujiekang.top/images/uploads/big/610bef88b65e92f36680f393957f7418.png)

把这些零零碎碎的单词丢去搜一下很容易搜到原文：

![](https://hujiekang.top/images/uploads/big/11c7700e5b8986503a55ed7bb04741b4.png)
...
![](https://hujiekang.top/images/uploads/big/e2b7e3eda755286381f316443856e3b4.png)

# 关卡6

附件是一个Word文档，在Word文档里显示隐藏文字可以读到一截flag，以及拿到一张图片。书签的内容是一个Base32编码，解码后得到`175.178.148.197`

![](https://hujiekang.top/images/uploads/big/25a8c10166fb890460c66672305c3baa.png)

主要还是对工具用的不熟啊，比赛的时候以为Outguess工具不需要密码，看见输出里没有信息以为这个图片只是放在那好看的。。。输入密码123456，成功解密：

![](https://hujiekang.top/images/uploads/big/e1d1539bf8dc286561acccdf89461e11.png)
