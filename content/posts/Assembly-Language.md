...
![](https://images.hujiekang.top/blogimage-c2abc93b7ad23c99f9eeb4dbc9d3639b-5024202b.png)
...
![](https://images.hujiekang.top/blogimage-86e5797de96d6bff9f097a58e5d0684f-3ea002c9.png)
...
![](https://images.hujiekang.top/blogimage-ab9cbc5a7e6c9f46f929fe381d75a292-089fc19a.png)
...
![](https://images.hujiekang.top/blogimage-20761b889eb89c0eebe905b1fe7a7eb9-f7a9fa93.png)
...
![](https://images.hujiekang.top/blogimage-ec13f7cf2802f867c3a004fd2d3f4e80-89510f54.png)
...
![](https://images.hujiekang.top/blogimage-d23a7bcaff0f895c703454833f506bef-bcac5ce1.png)

- (3) 查看内存中的内容：PC机主板上的ROM中写有一个生产日期，在内存`FFF00H~FFFFFH`的某几个单元中，请找到这个生产日期并试图改变它。

查看结果如下：

![](https://images.hujiekang.top/blogimage-f10a75fe8eef2eeac3916aa5ac08b8a2-ec2fa1f7.png)
...
![](https://images.hujiekang.top/blogimage-ad30f46abc2dd231e825beea3767ca27-442ddd51.png)
...
mov sp,10   ;与上一步一起执行
```
![](https://images.hujiekang.top/blogimage-ec8c9b38e544ca228e9fc002cb52d647-d81def43.png)

### 实验任务

- (1) 使用Debug，将下面的程序段写入内存，逐条执行，根据指令执行后的实际运行情况填空。

![](https://images.hujiekang.top/blogimage-fbc48483870f217cb4b5ea4ba2059799-6edae080.png)

- (2) 仔细观察图中的实验过程，然后分析：为什么`2000:0~2000:f`中的内容会发生改变？

![](https://images.hujiekang.top/blogimage-05c453dcc585f92bc7b43cbddbbd2890-2812c8e6.png)

`t`命令是单步执行的，所以在执行的过程中触发了单步中断，而中断需要栈来保护原程序的数据，所以在中断时将数据写入了栈中。
现在还不太懂中断，先贴一张后面的图：

![](https://images.hujiekang.top/blogimage-088950c0200ca639e9f40e4aa7e10733-f0a55079.png)
...
![](https://images.hujiekang.top/blogimage-d2a409f248b5be37bdce24a99ad80287-d14052a6.png)

接下来可以使用Microsoft Overlay Linker对目标文件进行连接。同样输入输入目标文件路径、输出可执行文件路径、映像文件路径（中间结果，可以不用生成）和库文件路径（无子程序调用，可以不用输入）：

![](https://images.hujiekang.top/blogimage-9081fd881bb00e61cf6cc02463d5062e-700bc2e4.png)

编译和连接也可以简化操作：输入`masm 源程序文件路径;`则直接在当前目录生成目标文件；输入`link 目标文件路径;`则直接在当前目录生成可执行文件。

![](https://images.hujiekang.top/blogimage-7517cc2e0ed6411b7367903338328e2c-b2849c35.png)
...
![](https://images.hujiekang.top/blogimage-fddd734480e02ec8b8b8453d4106ec0e-df4a093b.png)
...
![](https://images.hujiekang.top/blogimage-2e263f774dde5d829dad41f4e1686e9e-677894e1.png)
...
![](https://images.hujiekang.top/blogimage-bcf09887e699ee36bfa1cfdf83819692-e3b313e9.png)
...
![](https://images.hujiekang.top/blogimage-1818d5bfe0cbea9c6a9a229151c64a26-36ba6ba6.png)

若循环次数过多，逐步执行过于麻烦，可以使用`g`命令可以直接跳至某个地址开始执行：

![](https://images.hujiekang.top/blogimage-f5e719acf7f292c08b99d449f9720d6d-4c50598c.png)
...
![](https://images.hujiekang.top/blogimage-68def18d9d0b807b4589dbd0ab680c8e-f92aa3c2.png)
...
![](https://images.hujiekang.top/blogimage-6d5f23aa5c39d641c2661a8b65f52294-fa5f0619.png)
...
![](https://images.hujiekang.top/blogimage-073f76611aed4fe58432435d08fafb71-ba00c2a6.png)
...
![](https://images.hujiekang.top/blogimage-fba5b604c579db4d24a44be7c2365435-425ce9f1.png)
...
![](https://images.hujiekang.top/blogimage-27f3e4db61902f56dd757b335002d322-e45b7208.png)
...
![](https://images.hujiekang.top/blogimage-b96c210827ca47501e2e146abb60c564-8fb6da0d.png)
...
![](https://images.hujiekang.top/blogimage-2c6a9f85cea3023db47515c9b32448d3-242b00e3.png)
...
> 调试结果如下图：
>
> ![](https://images.hujiekang.top/blogimage-ebf11b4f3b9dda8aece562cc1fa7f4c4-779ead21.png)
...
- (2) 编程，完成问题7.9中的程序。
  ...
  ![](https://images.hujiekang.top/blogimage-dde9e036162ab59b10b0e8b83b58d4cf-c1e6a5e0.png)
...
![](https://images.hujiekang.top/blogimage-bda41050d4b438211a330c2f03b1d508-d6c1808e.png)
...
![](https://images.hujiekang.top/blogimage-c1e46e09023c635a9153499c4d7cc0ce-03f0ec34.png)
...
![](https://images.hujiekang.top/blogimage-80cf31adf65436a47da0be43d275fec0-0cb4ce6d.png)

可以看见对应的机器码为`EBF6`，即偏移的位移量为补码`F6`，对应数字`-10`。

将其放入`s`段，从`jmp`指令的下一个字节开始向前数`10`个字节，刚好位于整个代码段的开始位置，Debug中显示指令为`jmp 0000`：

![](https://images.hujiekang.top/blogimage-100dc610063df85bb93a423477f7aaf9-f31895c7.png)
...
![](https://images.hujiekang.top/blogimage-0e83a628f858598263138eb91be85cee-1a9efc81.png)
...
![](https://images.hujiekang.top/blogimage-fe12ec317763227e24fb91ce8ce35e21-5146e850.png)
