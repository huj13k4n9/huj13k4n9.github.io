...
![](https://images.hujiekang.top/blogimage-08b9fe61c34dfbf0a9a323d83126ab17-26f64c84.png)
...
![](https://images.hujiekang.top/blogimage-b7c702a31481a3dc46f0a53bad3d90c8-be5e4733.png)
...
![](https://images.hujiekang.top/blogimage-6371d325d039c4ffca73d986ac8ef2ae-1f95129b.png)
...
![](https://images.hujiekang.top/blogimage-4dcf2a3bc8dffea584531ef832241ae1-0f5a0a96.png)
...
1. 位扩展，将输入的32bit扩展为48bit，扩展规则如下：
   ...
   ![](https://images.hujiekang.top/blogimage-0ae8254af3d377749529a379f1ff3147-2a791d63.png)
...
![](https://images.hujiekang.top/blogimage-4168bd842a83adb2ed971319ee2b7f9e-493f4070.png)
...
2. S盒代换
   ...
   ![](https://images.hujiekang.top/blogimage-2b2084922cded982e659688b2fb245af-181fc1b6.gif)

## 行移位

行移位是将输入的矩阵各行进行循环移位，第1行不移动，第2行循环左移1字节，第3行循环左移2字节，第4行循环左移3字节，如下图所示：

![](https://images.hujiekang.top/blogimage-9f02afe11f8d81461234d84de0bdb95f-73d6143f.gif)
...
![](https://images.hujiekang.top/blogimage-5de67f479c14f5a0bd71db58c6f2c2d9-9c0720ee.gif)

## 轮密钥加

轮密钥加是最简单的一步，只需将输入矩阵和轮密钥异或即可。

![](https://images.hujiekang.top/blogimage-ab090e5a10d5b4c50bc1a4b72cbd7778-2a4e1f85.gif)
...
![](https://images.hujiekang.top/blogimage-94c3d2b8430034bdae8e0ebcdb6bc493-43f6ce4c.gif)
...
![](https://images.hujiekang.top/blogimage-771959b9899e955aaa2fe4f9e767e11d-fba93c88.png)
...
![](https://images.hujiekang.top/blogimage-ab7c85a6c34258b8f488903ab8bcefb5-adfa7d86.png)
...
![](https://images.hujiekang.top/blogimage-0d44ca19172ab188d2ac4432c7a867b7-e82f13f1.png)
...
![](https://images.hujiekang.top/blogimage-c19c3221b5188f8b4109dae62fada4d2-45cf9bd1.png)

## CFB模式

CFB(Cipher Feedback)密文反馈模式直接将上一分组的**密文**输入加密，再将输出和明文进行异或。利用CFB可以将分组密码转换为一个自同步的流密码。CFB模式的错误传播有限，适合以比特或字节为单位的数据。

![](https://images.hujiekang.top/blogimage-a678d1854d82aeb6cb6c78804740987b-816a07ed.png)
...
![](https://images.hujiekang.top/blogimage-26a99e64445f3b4b14118212a48bb6a5-d7ec83d8.png)
...
![](https://images.hujiekang.top/blogimage-1ada440c864bb51ac03832908e9f8f09-4985099a.png)
