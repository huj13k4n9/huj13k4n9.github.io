...
![](https://hujiekang.top/images/uploads/big/ea31f0ef8a2864a898c809ede923a53b.png)

题目要求使用51端口访问这个网页，于是使用`Curl`中的`--local-port`参数即可拿到flag：
（查了一下发现也可以通过Socket编程实现，等学完计网编程再来整一个）

![](https://hujiekang.top/images/uploads/big/f9c54db3d005d29f368264c071c18169.png)

## LOCALHOST

题目链接：<http://web.jarvisoj.com:32774/>

![](https://hujiekang.top/images/uploads/big/029d621234de681ddab9a9b264a3a3e8.png)

提示只能使用localhost地址访问，于是抓包后添加`X-Forwarded-For: 127.0.0.1`行，提交拿到flag：

![](https://hujiekang.top/images/uploads/big/d0faf73563fef5474dfaf3dbb4574d9c.png)

## Login

题目链接：<http://web.jarvisoj.com:32772/>

![](https://hujiekang.top/images/uploads/big/c1d633a3a8aa0bd0038393e052324803.png)
...
![](https://hujiekang.top/images/uploads/big/8b153c5cea0540d7cd009bf1616ef7e2.png)
...
![](https://hujiekang.top/images/uploads/big/5fef0ff7d7438a8d4718f48a1b1d3fd1.png)
...
![](https://hujiekang.top/images/uploads/big/0625e096424948397445abf4c7346278.png)
...
题目文件：[点击下载](/downloads/udf.so.8d1686fa7f3fe70c213879c9ad90cf73)
...
![](https://hujiekang.top/images/uploads/big/8889c8bcd67a55b1ab3e5eacbe2dfa5d.png)
...
![](https://hujiekang.top/images/uploads/big/19813a513f82d440977a8f053ac58118.png)
...
![](https://hujiekang.top/images/uploads/big/472eab897f53aeb3b077a6594de4cb6b.png)

然后我们把最底下那串字符进行URL编码后作为`role`参数的值：

![](https://hujiekang.top/images/uploads/big/66ca39ea5198cade5ba0803a57916003.png)
...
![](https://hujiekang.top/images/uploads/big/f5df6fd3d6a300eaa78b46d57f4c65fa.png)
...
![](https://hujiekang.top/images/uploads/big/834b406d0da069aa045958ab24834d6c.png)

点击管理员登录，提示不是管理员禁止访问。然后看一下源代码，提示管理员的IP是202.5.19.128：

![](https://hujiekang.top/images/uploads/big/755dff1806fb678f00c058b7b31ad578.png)
...
![](https://hujiekang.top/images/uploads/big/a3187359d5bb3ee08794b36e08c2b944.png)
...
![](https://hujiekang.top/images/uploads/big/7c20883e73714c2be794f46fdc3ae112.png)

那就POST试一下叭：

![](https://hujiekang.top/images/uploads/big/75bb939acff4fe7248da2e56f8bb2dd9.png)

## Easy Gallery

题目链接：<http://web.jarvisoj.com:32785/>

![](https://hujiekang.top/images/uploads/big/dba5e7568da3f25b9e1cf3d7353cd4a5.png)
...
![](https://hujiekang.top/images/uploads/big/31aab2652bf4d12a6da061414aa829fc.png)

然后在View界面，输入ID和文件类型jpg，得到图片的地址：

![](https://hujiekang.top/images/uploads/big/abd8aeb478cd126832ef4be8219e2e68.png)
...
![](https://hujiekang.top/images/uploads/big/f1cdc624a92efd76235d5f255eb3e1b4.png)

然后百度查找原因，发现PHP在低版本中还有另一种脚本格式：`<script language="php">code...</script>`，于是修改后上传，然后进行包含再加%00截断，拿到flag：

![](https://hujiekang.top/images/uploads/big/6e357e4b652c4af4d8422edd52aeca32.png)
...
![](https://hujiekang.top/images/uploads/big/849d0183d6e9fa67cab6c6ddfcd3cc7d.png)

把密码用md5解密，拿到真正的密码，登录拿到flag：

![](https://hujiekang.top/images/uploads/big/87fba434c026a89e16fd9e04624f332a.png)

![](https://hujiekang.top/images/uploads/big/56457a46bd71879986293a397f747795.png)
...
![](https://hujiekang.top/images/uploads/big/b301fd79931650b96ca7bba3fe79f9f1.png)

这题目反正就是输入什么，上面那个文本框就会显示什么，然并卵。。。并不能进行XSS。。。

于是查看源代码，发现程序使用`XMLHttpRequest`传递了json数据给/api/v1.0/try目录：

![](https://hujiekang.top/images/uploads/big/c4e2e45d487b5c6ea19e9162e57dfe69.png)

看到这种结构化数据，就想到了XXE，于是抓包把格式改成XML，然后使用XML实体读取/home/ctf/flag.txt文件，拿到flag：

![](https://hujiekang.top/images/uploads/big/361bb59e533e50773b744c4aee8cb4bd.png)
...
![](https://hujiekang.top/images/uploads/big/83474e5e44dd04975028c6e5254e20bf.png)

然后通过`checkpass`定位到了`__checkpass__REACT_HOT_LOADER__`：

![](https://hujiekang.top/images/uploads/big/c8d6cb16d6eb27721aec26e1920abdb1.png)
...
![](https://hujiekang.top/images/uploads/big/01095cb6cab683eeea23e0dc0f14e961.png)
...
![](https://hujiekang.top/images/uploads/big/1a89348279fd5c3ca27fad59f5d23c74.png)

于是尝试Payload：``table=flag` `union select 1``（表名flag我猜的&#x1F602;），发现返回值没有变化，于是增加列数，发现返回均为`D`，于是得知数据表只有一列。

接下来就是一套纯手工的注入了：

![](https://hujiekang.top/images/uploads/big/db0530f44877ae94b146da15339d27d4.png)

## [61dctf]babyphp

题目链接：<http://web.jarvisoj.com:32798/>

![](https://hujiekang.top/images/uploads/big/32c93eb09e2432256339426747bc95eb.png)

网页有三个Tab，全部点了一遍，发现About页中提到用了Git，于是想到Git泄露，用Git_Extract扫一哈拿到源码：

![](https://hujiekang.top/images/uploads/big/c1f474584a1580c44f367e0104782fa5.png)
...
![](https://hujiekang.top/images/uploads/big/c397a5cc65dfe81f228082dc8bba9680.png)
...
![](https://hujiekang.top/images/uploads/big/63cb0cf9d6589dc6a4ba1e02c0fed1da.png)
...
![](https://hujiekang.top/images/uploads/big/d303bb9b280bed5ecfdd96ee94aee2c3.png)
...
![](https://hujiekang.top/images/uploads/big/bea72bb815a632a81cb28f1df132a783.png)
...
![](https://hujiekang.top/images/uploads/big/88472b218947674db54d8a8f4058dd53.png)
