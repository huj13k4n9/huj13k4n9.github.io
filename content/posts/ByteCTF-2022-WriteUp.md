...
![](https://images.hujiekang.top/blogimage-babcf0697f6ee29b68b6e644dc861820-913c9c36.png)
...
![](https://images.hujiekang.top/blogimage-52a9ab5291597f63242dc4db81b497e1-d4cb3379.png)

继续看源码，发现在public目录下有个app目录，长下面这样：

![](https://images.hujiekang.top/blogimage-f479ed9ff58c6eb912463aee6f5bb231-c88e25e3.png)
...
![](https://images.hujiekang.top/blogimage-0da313f4318752c7ed1599e387aca8a4-86810423.png)
...
![](https://images.hujiekang.top/blogimage-e1cc772f6c32c29ab24be4fb4b959135-4bc8e7d0.png)
...
![](https://images.hujiekang.top/blogimage-73f4163bbd8a1772942256d530188eee-40b307e9.png)
...
![](https://images.hujiekang.top/blogimage-59c9ce47b60cdadaf4ca0fa052929975-47e4e089.png)
...
![](https://images.hujiekang.top/blogimage-f9e587fd0fdb667e3af72e5bd7990a37-80054421.png)

## find_it

下载附件，是个`.scap`文件，一搜还以为是UEFI固件，然后用`file`确认了一下，原来是个流量包hhh

![](https://images.hujiekang.top/blogimage-c5577422032f2dc5eb2e2d71ef54adf4-4753cb42.png)
...
![](https://images.hujiekang.top/blogimage-4b05ec116f0014384f97fe01cc6dad11-2a7e0b06.png)

以及下面这个一句话木马的写入操作，更确定了这个猜测：

![](https://images.hujiekang.top/blogimage-484beac7115e91add986c9361d8f5ce3-d18f567d.png)

在对Web日志的写入调用中发现了写一句话的具体URI，还是个ThinkPHP：

![](https://images.hujiekang.top/blogimage-249f3a6f02b5c711090a3f1c09f1ff70-0cc842cb.png)

紧跟在`bash nothing.sh`之后的是一个`openssl`加密命令，能推测出传了个图片文件nothing.png（看样子出题人也和我一样没钱恰KFC疯狂星期四捏）

![](https://images.hujiekang.top/blogimage-7f3881c9dcbd9938b7a08b7815e1869d-1ba9fbb4.png)

于是去掉filter之后，在其前面的某个`read()`调用中找到了nothing.png，扫出来是前半截flag：`bytectf{53f8fb16-a25d-4aac-`

![](https://images.hujiekang.top/blogimage-319877a44b8f3fae93b7e48763ccbd22-38ec6d75.png)

然后看来看去也没看见其他的命令执行了，想起前面翻到的Web日志，于是接着去找Web的请求信息，找到了这样一个`write()`调用：

![](https://images.hujiekang.top/blogimage-f576e63bb764c459e99b23b15cb3d6e5-98af14f1.png)
