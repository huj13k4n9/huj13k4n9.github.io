...
![](https://hujiekang.top/images/uploads/big/78d8b2b1c181e8abe834a78b436781e3.png)
...
![](https://hujiekang.top/images/uploads/big/298a55c8f5131105fb28485491237373.png)

一开始先试了一下，访问一哈404的目录，发现只是返回正常的404界面；然后给主页加一些乱七八糟的参数，返回了错误，错误中泄露了软件版本（后面发现是我蒙中了s参数）：

![](https://hujiekang.top/images/uploads/big/00f8371efa15696e55465f8fbfc3d79b.png)
...
![](https://hujiekang.top/images/uploads/big/1068344b5b7d17e153dd36f690cd9c54.png)
...
1. 双写+`php://`伪协议
   ...
   ![](https://hujiekang.top/images/uploads/big/d9d18d00119f5e2ea1e264ac8802588e.png)

![](https://hujiekang.top/images/uploads/big/392a1a3fa10889d4ff7a822402d7c705.png)

​	Payload2：`?page=PhP://filter/read=convert.base64-encode/resource=fl4gisisish3r3.php`，解码拿到flag

![](https://hujiekang.top/images/uploads/big/6649ad9a674a7f10451ec1450cf2d440.png)
...
2. data协议任意命令执行（明文和base64都可）
   ...
   ![](https://hujiekang.top/images/uploads/big/95dad4b8af770cb67bfa7ff961a93795.png)
...
4. <s>套娃</s>
   ...
   ![](https://hujiekang.top/images/uploads/big/84911978bf4908a1c8e41420ff72b28f.png)
...
![](https://hujiekang.top/images/uploads/medium/2c16c568431b4c7c3010cb8fb57bbf6b.png)
...
![](https://hujiekang.top/images/uploads/big/bed5f4ba3019165bc7057e98b7639630.png)
...
![](https://hujiekang.top/images/uploads/big/df478300cf9b7a8ee523efbf59672764.png)
...
![](https://hujiekang.top/images/uploads/big/4a89194f159f0c3c01c98c66b496e39d.png)
...
![](https://hujiekang.top/images/uploads/big/b917f12a795fd78d9229a8d8b2ebfb20.gif)

然后就用SQLMap爆：`python sqlmap.py -r 1.txt --dump`

![](https://hujiekang.top/images/uploads/big/9534e803f1ccee29ed8132313e211abf.png)
...
![](https://hujiekang.top/images/uploads/big/90eeab8124fc136fa35b75c8b98b6882.png)

## unserialize3

![](https://hujiekang.top/images/uploads/big/e0c2a18f3927c317d392d1a4237b65a3.png)
...
![](https://hujiekang.top/images/uploads/big/ee2185536297b91dfc72f72f15dce9ee.png)

![](https://hujiekang.top/images/uploads/big/25683a1e558c4b6caafad1e61d513ea3.png)
...
![](https://hujiekang.top/images/uploads/big/c31b61ef4fa34881c7832d5c2726a5c3.png)
...
![](https://hujiekang.top/images/uploads/big/2cdbbfa15d696da7fc08885ad1e97ec1.png)

## supersqli

这题是一个比较特别的SQL注入，之前没碰到过

![](https://hujiekang.top/images/uploads/big/bc1bd510c83e4b2b6de5e1d2190a0d0b.png)

一开始先尝试注了一下，发现有错误回显，然后摸到是字符型注入，使用`--+`注释可以注入，`order by`也可以执行，猜出来表列数为2，但是想用union的时候，发现被过滤了：

![](https://hujiekang.top/images/uploads/big/5de806e3b4f1059d8198af46347869d2.png)

由于开了不区分大小写，而且双写也莫得。。。所以这些关键字就没办法绕了，只能想点别的办法

试一下多语句执行，发现可以整：

![](https://hujiekang.top/images/uploads/big/b390d81db44d31cdc639180e8bcbd0b9.png)
...
![](https://hujiekang.top/images/uploads/big/1cbf22575ced20946a3c7db8797d2987.png)
...
![](https://hujiekang.top/images/uploads/big/62c09c1118eb6700b100955bfada0355.png)
...
![](https://hujiekang.top/images/uploads/big/385bef9ab16370675017f973b3d5165c.png)
...
![](https://hujiekang.top/images/uploads/big/5797bee30b5814c3d04674190ea070bc.png)
...
![](https://hujiekang.top/images/uploads/big/591a202a601207001fab4b4f122de8ad.png)
...
![](https://hujiekang.top/images/uploads/big/382eda1a8aa93b21434c788b6a44aa8f.png)
...
![](https://hujiekang.top/images/uploads/big/3fa17068ce89997c968a4538184f88db.png)
...
![](https://hujiekang.top/images/uploads/big/ccabde59200024ec56c849e91ad03c13.png)
...
![](https://hujiekang.top/images/uploads/big/5e524c82c66082f71e2638d3d05a301c.png)
...
![](https://hujiekang.top/images/uploads/big/4e13acfcecf7abeffc306a9138a1a46f.png)
...
![](https://hujiekang.top/images/uploads/big/014e610ce8ebad092b5b26206e999c4a.png)
...
![](https://hujiekang.top/images/uploads/big/1914f67bceb021bb943d60d5dd1802e6.png)

一开始看见login，以为登录框有SQL注入，然后点join，输入信息后就可以在网站里面添加一条数据。

![](https://hujiekang.top/images/uploads/big/ea94e6efc348c3cd853702a84502ef50.png)

点击用户名，来到`/view.php?no=1`，然后又感觉这里也可以注入，先对login测了一下，发现好像莫得注，然后对这里试了一下`no=1'`，发现报错。

然后就是一阵愉快的`union select`，然后发现对空格做了过滤，尝试注释绕过，成功：

![](https://hujiekang.top/images/uploads/big/ad4cab158573d6d00f79ca442bc03d11.png)

接下来就用SQLmap去跑，发现怎么都弄不下来数据，所以只能手工注了：爆出字段`no`，`username`，`passwd`，`data`，前三个数据就是在join输入的数据，只有`data`，是一段序列化对象：

![](https://hujiekang.top/images/uploads/big/e936488912940d9ad9ad203cb54706ed.png)
...
![](https://hujiekang.top/images/uploads/big/020d4e8fde194dc6b9105ff8b97d5ff3.png)
...
![](https://hujiekang.top/images/uploads/big/51786ec87c11b34c8325205236ec488b.png)

## FlatScience

在这题第一次接触SQLite的注入，感觉比MySQL的简单一点点

![](https://hujiekang.top/images/uploads/big/3cdf22e7a86151d7eac6f2e5213c8cff.png)
...
![](https://hujiekang.top/images/uploads/big/662abb903dfd8a22ee090e9658bf0c37.png)
...
![](https://hujiekang.top/images/uploads/big/9ffae77587d776d5a006f19fb6878722.png)

正好`admin.php`里面用户名默认也给的admin，于是尝试密码`ThinJerboa`，直接拿到flag：

![](https://hujiekang.top/images/uploads/big/4a5789041bb4b939dc0a6892c92b7efc.png)
...
![](https://hujiekang.top/images/uploads/big/36f6d429d0d6e043a7d867881da0a9e4.png)