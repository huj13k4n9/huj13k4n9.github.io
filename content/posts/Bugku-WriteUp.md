...
![](https://images.hujiekang.top/blogimage-7a4d05a9003ab2ddfbffc7e2725b830a-15d54656.png)

先看看这个正则表达式`/\d+/sD`的含义：

![](https://images.hujiekang.top/blogimage-4ddefd2b5a30a37ecd22b93c034e351c-b8657771.png)
...
![](https://images.hujiekang.top/blogimage-d5cf9f801980f6a0ae7c86df9b11c800-688ddee9.png)
...
![](https://images.hujiekang.top/blogimage-c9f8616e5c097718bebe69512abf2ff7-40d87852.png)
...
![](https://images.hujiekang.top/blogimage-e5185acf3ad5c134f73c16b1d5aff610-56f9e291.png)
...
![](https://images.hujiekang.top/blogimage-d10d678c9bc13a5aa0ccf0d6a3d45358-835bc833.png)
![](https://images.hujiekang.top/blogimage-1469f908c7c892b2fb889c5934ef7841-0ea28897.png)

看了一下别人的WriteUp，只需要传入`a=`即可，因为使用`file_get_contents()`函数去读的文件如果不存在的话，那么会返回`false`。而空字符串与`false`做等于运算返回的是`true`，所以也可以打印出flag。

![](https://images.hujiekang.top/blogimage-d3f9a5c7b6023fba497c57d3584b2445-e1199c41.png)
...
![](https://images.hujiekang.top/blogimage-dffc824e50f78d558f9a25c3674bfffb-0208321b.png)

这一行字直接暗示（明示）了一些信息：使用PUT方法发送信息bugku即可拿到flag。

使用BurpSuite修改请求头，拿到一段字符串：

![](https://images.hujiekang.top/blogimage-c62976d81fa4bcf502022d6a77877147-c3c720e9.png)
...
![](https://images.hujiekang.top/blogimage-a61a3e0a4f3347b5bf65296e5571be4d-6e8fff4e.png)
...
![](https://images.hujiekang.top/blogimage-180e4061a84cb469eeff0f13e2aa08cb-0fdbd813.png)
...
![](https://images.hujiekang.top/blogimage-0ca7974ebaaebe1c33b520f6ffb4e094-2cc970b2.png)

## web6

题目链接：[http://123.206.31.85:10006/](http://123.206.31.85:10006/)

![](https://images.hujiekang.top/blogimage-1dee641801d0b2b99e1fb265ea8ef5fc-ca669562.png)

页面是一个登录框，随便输入密码提示`IP禁止访问，请联系本地管理员登陆，IP已被记录.`。

既然要联系本地管理员登录，不妨伪装成内网IP再登录试试：

![](https://images.hujiekang.top/blogimage-64d73b4ebddbd226c94af9f86072b7d9-0506baab.png)
...
![](https://images.hujiekang.top/blogimage-e701eb9dcd4400241e9e7f739dc9cdc4-956a3ce4.png)
![](https://images.hujiekang.top/blogimage-72267f83c991540acfc5fc3a01d9b3cd-e285da40.png)

**更新：看了一下别人的WriteUp，发现不用爆破。。。源代码最底下已经给了密码。。。**

![](https://images.hujiekang.top/blogimage-435c582e9aa6f39d62c4fdffd51c7f7e-965277dc.png)

## web11

题目链接：[http://123.206.31.85:3030/](http://123.206.31.85:3030/)

![](https://images.hujiekang.top/blogimage-8d1a47002754c62c2300000effd0bb13-4fd8fc22.png)

标题是robots，于是尝试访问`robots.txt`，发现位置`/shell.php`：

![](https://images.hujiekang.top/blogimage-f602ff768621f10b56c5aa226959cc67-ffc5472d.png)
![](https://images.hujiekang.top/blogimage-306c178bae377275ad8f89cfa6164e27-bc25941b.png)
...
![](https://images.hujiekang.top/blogimage-5af5ff0b05b2128860f828beb9cc2bcc-ee20e199.png)

填入内容，拿到flag：

![](https://images.hujiekang.top/blogimage-5d04ad4891c6996fa621e9dc50981e83-98089ba7.png)

## web13

题目链接：[http://123.206.31.85:10013](http://123.206.31.85:10013)

![](https://images.hujiekang.top/blogimage-3b4839206231def48fe8b2f1121a0ac5-7739bf18.png)
...
![](https://images.hujiekang.top/blogimage-4b8939d6159c2fa2f3aba498b5e01676-f0aea1bd.png)
...
![](https://images.hujiekang.top/blogimage-1950471a2a11c17099c13b46f4c759b7-30bf044a.png)
...
![](https://images.hujiekang.top/blogimage-6cfb226ab106f2b2a967fd7c8ad73ec5-2941188f.png)
![](https://images.hujiekang.top/blogimage-6a97228b53b6a4e8f401658f5ed14d6a-61deae27.png)
...
![](https://images.hujiekang.top/blogimage-f18c5cf23303ab9500c9b04ad272ea44-2811cf33.png)
...
![](https://images.hujiekang.top/blogimage-500cbd21113defa17158e0680661680b-a32afafe.png)
...
![](https://images.hujiekang.top/blogimage-ce4b8ad05821ca8d4a18752d05d74fbc-1608bb94.png)
...
![](https://images.hujiekang.top/blogimage-a02b3c5951b57b943ffc66844f066510-9b1e4875.png)

看着像是一个字典文件，尝试使用这个作为字典对主页进行爆破提交，发现均返回wrong。

那这个字典有什么用呢？难道还有别的地方提交数据吗？于是使用扫描器扫描站点，发现果然还有一个`shell.php`：

![](https://images.hujiekang.top/blogimage-7b5bf9225d3a0d84ba7eddc7e9bb8bd2-1b8ab57b.png)

打开再次爆破提交，得到flag：

![](https://images.hujiekang.top/blogimage-bde5bb8290f7b1acb03eb69086b72785-27a8f7eb.png)

## web3

题目链接：[http://123.206.31.85:10003/](http://123.206.31.85:10003/)

![](https://images.hujiekang.top/blogimage-6e9d48ebf473a27d0f0feb28f8491e3e-5e22c0df.png)

点击链接，进入一个上传页面，同时发现有一个get参数op，立马想到文件包含漏洞。
构造参数`op=php://filter/convert.base64-encode/resource=flag`拿到base64编码字符串，解密后得到flag。

![](https://images.hujiekang.top/blogimage-1e88d03c955bbd39d496365acd30328c-811c6e85.png)

## web4

题目链接：[http://123.206.31.85:10004/](http://123.206.31.85:10004/)

![](https://images.hujiekang.top/blogimage-f36d4d37fbd0bb54d4587a40297615ed-d0111faf.png)

最简单的SQL注入，输入用户名`1' or '1'='1'#`，密码留空直接提交拿到flag：

![](https://images.hujiekang.top/blogimage-977f94ca7f37beb8c6d8797565c1f436-e5f3cdff.png)
...
![](https://images.hujiekang.top/blogimage-85f4f3e4242ca3005eb6e81b8fea2837-3c98ecc9.png)
...
![](https://images.hujiekang.top/blogimage-30bce7265772fb77cc6fe8edadf819a3-fbce5074.png)
...
![](https://images.hujiekang.top/blogimage-019002d3f6248b724ca22e6710ce4f04-2ad1eac4.png)
...
![](https://images.hujiekang.top/blogimage-13b9668a109922dc327bd1b3a628583c-547282b1.png)
...
![](https://images.hujiekang.top/blogimage-23f5e9d897cd882b0878217e1e74053a-f24fc08f.png)
![](https://images.hujiekang.top/blogimage-e3ae839224c61f3557b25b3910c8a0d8-0a99641c.png)
...
![](https://images.hujiekang.top/blogimage-18e2ddf20f4f9dfd277d23bd747f2eb0-cdf86878.png)
...
2. 爆表名
   ![](https://images.hujiekang.top/blogimage-5195558e298b6cb17635da19b307a190-89894256.png)
3. 爆列名
   ![](https://images.hujiekang.top/blogimage-49278d5a9205aa827c9e4bc358fa3ba0-fce5582a.png)
4. 拿数据
   ![](https://images.hujiekang.top/blogimage-0fad50bd495bb2ed31a755f9bb5f3076-5d385f24.png)

## web14

题目链接：<http://123.206.31.85:10014/>

![](https://images.hujiekang.top/blogimage-c2bbcb8fde442cd06083d1493ed2a8cf-06dfe749.png)

打开就一个403页面，除此之外没有任何信息，查看网页源代码发现这是个假的403，注释提示要善于发现：

![](https://images.hujiekang.top/blogimage-491af926ab22773da5a4552b07377341-444a8a6a.png)
...
![](https://images.hujiekang.top/blogimage-2d79b93d41541e7054afc15f3bf1b236-9b30b52e.png)
...
![](https://images.hujiekang.top/blogimage-56c8691c15b0c2b6ae2a4bc924ac3cc5-bd175f9a.png)

打开页面提示你不是尊贵的admin所以啥都没有，但是查看源代码后发现了如何成为尊贵的admin：

![](https://images.hujiekang.top/blogimage-1b58db86c3880c614f6ec52f4fecec8c-106db9a3.png)

于是知道了，只需要通过`php://input`伪协议来传入`user`参数，就可以成为尊贵的admin了。除此之外注释中还暗示读取`class.php`，于是想到通过`php://filter`来读取：

![](https://images.hujiekang.top/blogimage-9b1a500f41ef5ba31136c6806570b50c-b3ab739d.png)
...
![](https://images.hujiekang.top/blogimage-ebcdfef92dc76d9ff66a07eb60a65464-d9fb420a.png)
...
![](https://images.hujiekang.top/blogimage-8695c6f40683954157c8151800ea3a52-59597595.png)

页面显示是一对男女的的爱情日记（谈恋爱之前还要先社工别人是真的狼灭），翻遍了也是没有找到什么信息。。。
然后把电脑里能用的工具全部用了一遍，结果发现又是`/.git`泄露：

![](https://images.hujiekang.top/blogimage-e438b14da28d081972af6c5b3e16f2f1-d367111c.png)
...
![](https://images.hujiekang.top/blogimage-1d545e4acc55e3138add82dd1964904f-72ed011d.png)
...
![猜数据库名](https://images.hujiekang.top/blogimage-b43ded653faa714ff057bb7a18bb806d-cad7dc97.png)

![猜表名](https://images.hujiekang.top/blogimage-fafbb08e3742032f7daab0f9c5f05b58-2a83b092.png)

到这里接下来本来要猜列名的，但是这里SQLMap死活注入不成，然后我就自己写了个小脚本试了一下，发现是网站挂了。。。而且神奇的是只有猜列名的时候挂。。。

![](https://images.hujiekang.top/blogimage-1c418c00820a00fbb2ea75ff77a899a0-16d97204.png)
...
![hlnt_2表的数据](https://images.hujiekang.top/blogimage-ebcb619785c8f8e2cfd43372ea5ba628-e61f6b11.png)

![user表的数据](https://images.hujiekang.top/blogimage-6bd50e6e138a54036e10b04eb5a1c7b6-0b41c2b6.png)
...
![](https://images.hujiekang.top/blogimage-51188bfdac98e3ac3bfeff4ab0d1d20d-923017e2.png)
...
![](https://images.hujiekang.top/blogimage-541b2d654e6e432783d8d364871484bf-bb01555b.png)

访问`http://123.206.31.85:10019/PPPPOOO0CCCC.php`，发现毛都没有，于是想到之前那张反序列化的代码图片，又在游记那儿到处乱翻了一哈，发现一个反序列化的对象藏在Cookie里面：

![](https://images.hujiekang.top/blogimage-a174603fa6412cc7e4454cf77b279e87-71df7eaf.png)

把反序列化对象改成`O:8:"ReadFile":1:{s:4:"file";s:20:"/../PPPPOOO0CCCC.php";}`后发包，就拿到flag了（Cookie中要进行URL编码）：

![](https://images.hujiekang.top/blogimage-e8abd239eacce8ef04ca0947648945d6-bf895d78.png)
...
![](https://images.hujiekang.top/blogimage-1019638d9574ac3ca39da6c71d93e73d-311d03fe.png)

访问`http://123.206.31.85:10024/index/index.php`，发现是代码审计：

![](https://images.hujiekang.top/blogimage-3b4e8a6f4c7a213c28991e8b9ec63e39-061728eb.png)
...
![](https://images.hujiekang.top/blogimage-a698f0d00c24c9e5a0c450ea2d3a1071-cb5a2afb.png)

把输出加给`var`参数，提交，拿到flag：

![](https://images.hujiekang.top/blogimage-bebbbf575960573ae7ca7041f9aa09c3-e0e8fdb0.png)

## web23

题目链接：<http://123.206.31.85:10023/>

![](https://images.hujiekang.top/blogimage-a98f6b961ddaffb435ec7b91f04a8a95-e0995477.png)
...
![](https://images.hujiekang.top/blogimage-94f67752cf83b3b482a333e96848dd7e-af9103c3.png)

## web16

题目链接：<http://123.206.31.85:1616/>

![](https://images.hujiekang.top/blogimage-772d96a8037cf73a52b7e3775b022ee4-4e73bbe2.png)
...
![](https://images.hujiekang.top/blogimage-cf2182565dbbec2079c58598b42d2386-ec40471f.png)
...
![](https://images.hujiekang.top/blogimage-26e1993f3150ffa698dfd53aa797b4f0-7872b5f2.png)

那为什么JS就有问题呢？首先PHP的算法是没有错误的，而JS里面调用的是网站上的base64函数，难道是这个函数被做了手脚？
查看`base64.js`，果然发现一个憨憨注释：

![](https://images.hujiekang.top/blogimage-500cdaabdea643640d7ef7ba2b978c80-d3591a73.png)
...
![](https://images.hujiekang.top/blogimage-270bb4e3d41ad1103ab673e5eed0afcc-8aa31ea7.png)
...
![](https://images.hujiekang.top/blogimage-2ca4c9c834a4fd1c692abbc714fd6884-0981d9a7.png)
...
![](https://images.hujiekang.top/blogimage-5a5b0af48b50be0983073d3dae8ef5ed-c55d78c3.png)
